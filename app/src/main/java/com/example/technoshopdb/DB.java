    ...
    public String administrar_productos(String accion, String[] datos){
        try {
            ...
            if( accion.equals("nuevo") ){
                db.execSQL("INSERT INTO productos(id,rev,idProducto,codigo,descripcion,marca,presentacion,precio, foto) VALUES('"+ datos[0] +"', '"+ datos[1] +"', '"+ datos[2] +"','" + datos[3] +"','"+ datos[4] + "','"+ datos[5] +"','" + datos[6] +"','"+ datos[7] + "','"+ datos[8] +"')");
            } else if (accion.equals("modificar")) {
                db.execSQL("UPDATE productos SET id='"+ datos[0] +"', rev='"+ datos[1] +"', codigo='"+ datos[3] +"', descripcion='" + datos[4] +"', marca='"+ datos[5] +"', presentacion='"+ datos[6] +"', precio='"+ datos[7] +"', foto='"+ datos[8] +"' WHERE idProducto='"+ datos[2] +"'");
